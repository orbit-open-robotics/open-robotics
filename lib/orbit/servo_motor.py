...
# raw angles - this is what the servo uses directly
# logical angle (angle) - this is the application value. It uses an offset and a sign
#     to relate it to the raw angle. The logical angle is given a range between angle_start
#     and angle_end
#
    ...
    async def run_loop(self, angle_inc: float = ANGLE_INC) -> None:
        ...
        while True:
            try:
                ...
                if self._state == ServoMotor.TERMINATED:
                    return
...
if __name__ == "__main__":
    # Test code
    servo_motor = ServoMotor(pin=10, angle_start=0, angle_end=180, name='Servo 2')
    print(servo_motor)
