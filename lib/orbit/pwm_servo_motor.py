...
if __name__ == '__main__':
    ...
    servo = PWMServoMotor(pin = 10, name='TestServo')
    print(servo)
    ...
    # Move the servo to end
    print('Move servo to end...', end='')
    servo.move_to_end(time=1.0)
    print('Done.')
    sleep(1)
    
    # Move the servo to start
    print('Move servo to start...', end='')
    servo.move_to_start(time=1.0)
    print('Done.')
    sleep(10)
